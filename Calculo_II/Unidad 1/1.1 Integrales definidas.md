...
$$
A=\frac{1}{2}\sum_{i=1}^{6}f\left( x \right)
$$
$$
\begin{align*}
A&=\sum_{i=1}^{6}x{^3}-6x\\
&=\sum_{i=1}^{6}x{^3}-6\sum_{i=1}^{6}x\\
&=\frac{6{^2}(6+1){^2}}{4}-6\cdot \frac{6(6+1)}{2}\\
&=441-6\cdot 21\\\\
\text{Está mal :(}
\end{align*}
$$$
Procedemos obteniendo los valores de $x_{i}$ sustituyendo $i$ por los números del 1-6:
$$
\begin{align*}
x_{1}&=3-\frac{1}{2}\cdot 1\\
&=\frac{5}{2}\\
x_{2}&=3-\frac{1}{2}\cdot 2\\
&=3-1\\
&=2\\
x_{3}&=3-\frac{1}{2}\cdot 3\\
&=3-\frac{3}{2}\\
&=\frac{3}{2}\\
x_{4}=
\end{align*}
